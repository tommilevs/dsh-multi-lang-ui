...
function isSafeDomSelector(selector) {
  ...
  const root = /^(?:\.[A-Za-z_][\w-]*|\[data-dsh-plugin="[A-Za-z0-9][A-Za-z0-9._-]*"\]|\[data-conversation-tabs\]|\[data-dsh-pet-root\]|#settings-pet-[A-Za-z0-9_-]+|section\[aria-labelledby="(?:vision|compact)-title"\]|p\[role="alert"\])/.exec(value)
